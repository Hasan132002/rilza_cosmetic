<x-admin-layout>
    ...
    <div class="max-w-4xl">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <form action="{{ route('admin.popup-campaigns.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="display_frequency" id="display_frequency" value="{{ old('display_frequency', 24) }}" min="1"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-200">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-200"
                                  placeholder="Enter the popup message here...">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="delay_seconds" id="delay_seconds" value="{{ old('delay_seconds', 5) }}" min="0"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-200">
                        @error('delay_seconds')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="col-span-2 space-y-3">
                        <label class="flex items-center">
                            <input type="checkbox" name="show_on_exit" value="1" {{ old('show_on_exit') ? 'checked' : '' }}
                ...
                <div class="mt-6 flex items-center justify-end space-x-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i>Create Popup Campaign
                    </button>
                </div>
            </form>
        </div>
