<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Edit Blog Post</h3>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="excerpt"
                                  id="excerpt"
                                  rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-100">{{ old('excerpt', $blog->excerpt) }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center px-4 py-2 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg border border-gray-300 dark:border-gray-600 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <span class="text-sm">{{ $blog->featured_image ? 'Change Image' : 'Choose Image' }}</span>
                                <input type="file"
                                       name="featured_image"
                                       id="featured_image"
                                       accept="image/*"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="meta_description"
                                          id="meta_description"
                                          rows="3"
                                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-100">{{ old('meta_description', $blog->meta_description) }}</textarea>
