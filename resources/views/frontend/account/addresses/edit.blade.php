<x-frontend-layout title="Edit Address">
    <!-- Header Section -->
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center" data-aos="fade-up">
                <h1 class="text-4xl md:text-6xl font-bold mb-4">
                    <i class="fas fa-edit mr-3"></i>Edit Address
                </h1>
                <p class="text-xl text-pink-100">Update your delivery address</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="city"
                                ...
                                <option value="Karachi" {{ old('city', $address->city) == 'Karachi' ? 'selected' : '' }}>Karachi</option>
                                <option value="Lahore" {{ old('city', $address->city) == 'Lahore' ? 'selected' : '' }}>Lahore</option>
                                <option value="Islamabad" {{ old('city', $address->city) == 'Islamabad' ? 'selected' : '' }}>Islamabad</option>
                                <option value="Rawalpindi" {{ old('city', $address->city) == 'Rawalpindi' ? 'selected' : '' }}>Rawalpindi</option>
                                <option value="Faisalabad" {{ old('city', $address->city) == 'Faisalabad' ? 'selected' : '' }}>Faisalabad</option>
                                <option value="Multan" {{ old('city', $address->city) == 'Multan' ? 'selected' : '' }}>Multan</option>
                                <option value="Peshawar" {{ old('city', $address->city) == 'Peshawar' ? 'selected' : '' }}>Peshawar</option>
                                <option value="Quetta" {{ old('city', $address->city) == 'Quetta' ? 'selected' : '' }}>Quetta</option>
                            </select>
                            @error('city')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="state"
                                ...
                                <option value="Sindh" {{ old('state', $address->state) == 'Sindh' ? 'selected' : '' }}>Sindh</option>
                                <option value="Punjab" {{ old('state', $address->state) == 'Punjab' ? 'selected' : '' }}>Punjab</option>
                                <option value="KPK" {{ old('state', $address->state) == 'KPK' ? 'selected' : '' }}>KPK</option>
                                <option value="Balochistan" {{ old('state', $address->state) == 'Balochistan' ? 'selected' : '' }}>Balochistan</option>
                            </select>
                            @error('state')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
